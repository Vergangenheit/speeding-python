...
def main():
    ...
    NUM_CORES: int = cpu_count() # Our number of CPU cores (including logical cores)
    OUTPUT_FILE = "./wiki_titles.tsv" # File to append our scraped titles to

    PAGES_PER_CORE: int = floor(NUM_PAGES / NUM_CORES)
    PAGES_FOR_FINAL_CORE: int = PAGES_PER_CORE + NUM_PAGES % PAGES_PER_CORE # For our final core
